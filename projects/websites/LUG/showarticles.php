...
$query = "SELECT * FROM articles ORDER BY no DESC";
...
echo '
	...
	<tr>
		...
		<a href="?page=article.php&no=' . $row['no'] . '">'. $topic .'</a> | '. $row['format'] .'
		<br>
		'.$row["catch"].'
		</td>
...
<br><h3>Came across sumthing gr8 about computers? <a onclick="showpage('login/home.php');">Upload an article on it.</a></h3>
</center>
