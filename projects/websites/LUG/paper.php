...
while($row = mysql_fetch_array($result))
{
	...
	echo '<table width="100%"><tr><td align="left" valign="bottom"><h3><a href=".">Home</a> : <a href="./?page=showpapers.php">Papers</a></h3><br><h2>' . $topic . '</h2>' . $row["format"] . '</td><td align="right" valign="bottom"><h3>Moderated : '. $moderated .' : Rating : '. $row["rating"] .'<br>Submitted by <i>'. $row["username"] .'</i> on '. $row["date"] .'</h3></td></tr></table><hr>';
